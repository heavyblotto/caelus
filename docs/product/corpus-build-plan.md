...
not in `lintCorpus` yet. The B1/B2 repair wave (eleven agents over 119
files, ~400 entries repaired) cleared its scope: zero B1/B2 findings
remain in any report. What is left is B3/B4 territory:


| Backlog                  | Findings | Repairs owed   |
| ------------------------ | -------- | -------------- |
| Near-duplicate sentences | 38       | 19 collisions  |
| Cross-family echoes      | 15       | 8 collisions   |
| Formula clusters         | 183      | 32 clusters    |
...
After the B1/B2 wave and its echo mop-up the report holds 34 pairs,
none internal to B1/B2.
