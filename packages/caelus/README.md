...
| precise Moon 1920–2080 (lazy-load) | ~750 KB |

The ~153 KB core computes natal charts client-side — planets to sub-arcsecond,
Moon to ~10″ via the analytic series, fixed stars from the bundled HYG catalog. The ~750 KB tier (1920–2080 JPL-fit Moon,
...
- [caelus-mcp](https://www.npmjs.com/package/caelus-mcp) — MCP server, thirty-five chart tools over stdio
