...
export const metadata = pageMetadata({
  ...
  description: "Give imaginary bodies motion over time: placement, periodic, and Kepler tiers; register them on Engine for transits, returns, and SkyView; report an unsatisfiable system as unsatisfiable.",
  path: "/docs/synthetic",
});
