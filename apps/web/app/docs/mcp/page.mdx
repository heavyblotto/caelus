...
There are two ways to connect, with the same eighteen tools either way:
...
After the client reloads, it should list **eighteen** tools. Ask it to enumerate
...
releasing / aphesis from the Lot of Spirit or Fortune), and `directions`
(primary directions of the planets to the angles).
...
If you see all eighteen, the server is wired correctly. The server also exposes two
