...
> the suite owns the **contract** between the two rather than any of the
> content itself.
...
| `dignityFine` | a finer essential-dignity fact |
| `vedic` | a nakshatra, varga, or yoga |
| `parallel` | a parallel or contraparallel of declination |
| `outOfBounds` | a body beyond the obliquity band |
...
This is library code, not ephemeris. There is no Swiss Ephemeris oracle for
